...
let pane = {
    ...
    addToPaneList(){
        ...
        this.createNodePaneList(name,this.records.length-1);
        this.attachToDOMPane();    
    ...
    removeFromPaneList(index){
        return () => {
            ...
            delete todoApp.records[this.records[index]];
            console.log(todoApp.records)
    ...
    createNodePaneList(name,index){
        ...
        //wed3
        // // let ob = new todos(todoApp.records[name]);
        // // ob.mount();
        // // ob.unmount();
        //wed3
    },
    ...
    attachToDOMPane(){
        ...
        this.records.forEach((item,index) => this.createNodePaneList(item,index));
    }
}
...
let todoApp = { 
    init(data,index)
    {
        ...
        this.records = data;
        //console.log(Object.keys(this.records));
